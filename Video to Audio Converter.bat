...
title Video to Audio Converter - by Munna MasterMind
...
echo.
echo        ╔═══════════════════════════════════════════════════╗
echo        ║   Video to Audio Converter by - Munna MasterMind  ║
...
if defined invalid set invalid= & goto ASK_BITRATE
if %brate_choice% lss 1 goto ASK_BITRATE
if %brate_choice% gtr 4 goto ASK_BITRATE
